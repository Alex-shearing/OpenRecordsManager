...
public class RecordProperties {
    public static final PropertyDefinition<IListElement> RECORD_SECURITY_CLASSIFICATION = PropertyDefinition.builder("record_security_classification", PropertyType.LIST_ITEM)
            ...
            .build();
    public static final PropertyDefinition<Collection<IListElement>> RECORD_SECURITY_IMM = PropertyDefinition.builder("record_security_imm", PropertyType.LIST_MULTIPLE)
            ...
            .build();
    public static final PropertyDefinition<Collection<IListElement>> RECORD_SECURITY_CAVEAT = PropertyDefinition.builder("record_security_caveat", PropertyType.LIST_MULTIPLE)
            ...
            .build();
    public static final PropertyDefinition<Collection<IListElement>> RECORD_SECURITY_RELEASABILITY = PropertyDefinition.builder("record_security_releasability", PropertyType.LIST_MULTIPLE)
