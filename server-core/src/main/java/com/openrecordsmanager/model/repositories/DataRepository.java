...
public class DataRepository {
    ...
    public DataRepository(AuthProviderRepository authProviderRepo, ConfigRepository configRepo, ListElementRepository listElementRepo, ListTypeRepository listTypeRepo, ObjectPropertyRepository objectPropertyRepo, RecordTypeRepository recordTypeRepo) {
